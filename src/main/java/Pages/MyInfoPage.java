...
public class MyInfoPage {
    ...
    By addbtn = By.xpath("(//button[@class=\"oxd-button oxd-button--medium oxd-button--text\"])");
    ...
    public void enterDateOfBirth(String date) {
        WebElement dateField = driver.findElement(By.xpath("(//input[@placeholder='yyyy-dd-mm'])[2]"));
